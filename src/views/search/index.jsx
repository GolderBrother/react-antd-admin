...
export default class Search extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            showList: [],
            listIndex: 0,
            searchSrcs: [{ btn: '360搜索', src: 'https://www.so.com/s?ie=utf-8&shb=1&src=360sou_newhome&q=' }, { btn: '百度一下', src: 'https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=0&rsv_idx=1&tn=baidu&wd=' }, { btn: '搜狐搜索', src: 'https://www.sogou.com/web?query=' }],
    ...
    selectUpAndDown = (e, keycode) => {
        ...
        if (keycode === 38) {
            this.setState({
                listIndex: this.state.listIndex === 0 ? 9 : this.state.listIndex - 1
            }, stateCb);
        } else if (keycode === 40) {
            this.setState({
                listIndex: this.state.listIndex === 9 ? 0 : this.state.listIndex + 1
            }, stateCb);
        }
    }
    ...
    onLogoChange = (index) => {
        ...
        this.setState({
            searchBtn: this.state.searchSrcs[index]['btn'],
            searchSrc: this.state.searchSrcs[index]['src']
        })
    }
            ...
            <div className="search">
                ...
                <div className="search-panel">
                    <div className="search-align">
                        <div className="search-left pull-left">
                        ...
                        <div className="pull-right">
                            <button className="search-btn" onClick={this.handleSearch}>{this.state.searchBtn}</button>
                        </div>
                    </div>
                </div>
            </div>
