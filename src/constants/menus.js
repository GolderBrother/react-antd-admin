export const menus = [
    { key: '/app/dashboard/index', title: '首页', icon: 'mobile', },
    {
        ...
        key:'/app/music',title:'音乐',icon:'sound',
    },{
        key:'/app/pic',title:'画廊',icon: 'edit',
        sub:[
            {key:'/app/album',title:'时光相册',icon: 'edit'}
        ]
    },{
        key:'/app/tools',title:'工具类',icon:'tool',
        sub:[
            {key:'/app/tools/smallapp',title:'小应用',icon:'tool'},
            {key:'/app/tools/todolist',title:'待办事项',icon:'tool'}
        ]
    },
    {
    ...
    {
        key: '/app/editor', title: '编辑器', icon: 'edit',
        sub: [
            { key: '/app/editor', title: '文本编辑器', icon: '', },
        ],
    },
    {
    ...
    {
        key: '/app/note', title: '记录当下', icon: 'star',
    },
];